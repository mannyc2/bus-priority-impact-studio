...
- `bun run corridor-model -- --year 2026 --month 3` produced 350 public route assignments, 193 corridors, 1,186 corridor hotspots, and 350 segment-backed route memberships. The model now prefers hotspot-segment street evidence before falling back to stop-name majority.
...
- Deterministic hotspot-segment corridor entities, route membership, summaries, hotspot rows, and generated brief bodies exist; shape-based corridor review remains open.
...
| Corridor grouping | Hotspot-segment corridor tables, route membership, summaries, hotspots, D1 readback, generated corridor brief bodies, and segment-evidence QA exist | Partial | Shape-based corridor review and corridor-specific intervention context |
...
- Local tables `local_corridor`, `local_corridor_route_member`, `local_corridor_month_summary`, and `local_corridor_hotspot` store corridor identity, route membership, segment evidence counts/scores, summary metrics, and top corridor hotspots.
