...
- strict v1 QA result covering local route/corridor evidence, required source probe freshness, GTFS-RT collection/parse/headway provenance, observed sample coverage, route-batch audit output, and D1 readback
