...
if (typeof document !== 'undefined' && !document.getElementById('dc-styles')) {
  ...
  s.textContent = [
    ...
    '.dc-editable:focus{background:oklch(0.995 0.004 75);box-shadow:0 0 0 1.5px #c96442}',
    ...
    '.dc-menu{position:absolute;top:100%;right:0;margin-top:4px;background:oklch(0.995 0.004 75);border-radius:8px;',
  ...
  return (
    <div ref={ref} data-dc-slot={id} style={{ position: 'relative', flexShrink: 0 }}>
      ...
      <div ref={cardRef} className="dc-card"
        style={{ borderRadius: 2, boxShadow: '0 1px 3px rgba(0,0,0,.08),0 4px 16px rgba(0,0,0,.06)', overflow: 'hidden', width, height, background: 'oklch(0.99 0.007 75)', ...style }}>
    ...
    <div onClick={() => ctx.setFocus(null)}
      ...
      <div
        ...
        <div onClick={(e) => e.stopPropagation()} style={{ width: width * scale, height: height * scale, position: 'relative' }}>
          <div style={{ width, height, transform: `scale(${scale})`, transformOrigin: 'top left', background: 'oklch(0.99 0.007 75)', borderRadius: 2, overflow: 'hidden',
