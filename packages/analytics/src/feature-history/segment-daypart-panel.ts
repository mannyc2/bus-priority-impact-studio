...
export type SegmentDaypartPanelArtifact = {
  readonly artifactKind: "segment_daypart_panel";
...
function buildPanelManifest(input: {
  ...
  return {
    ...
    limitations: [
      ...
      "This panel is an intermediate feature artifact; public claims need a serving projection with explicit provenance.",
    ],
  };
}
...
export function buildSegmentDaypartPanelArtifact(input: {
  ...
  return {
    artifactKind: "segment_daypart_panel",
    schemaVersion: 1,
    generatedAt: input.generatedAt,
