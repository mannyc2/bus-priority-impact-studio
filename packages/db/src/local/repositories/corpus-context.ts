    ...
    db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          streetCode1: sql`excluded.street_code1`,
          streetCode2: sql`excluded.street_code2`,
          streetCode3: sql`excluded.street_code3`,
          ...
          houseNumber: sql`excluded.house_number`,
          streetName: sql`excluded.street_name`,
          intersectingStreet: sql`excluded.intersecting_street`,
          violationTime: sql`excluded.violation_time`,
          matchLocationKey: sql`excluded.match_location_key`,
        },
      }),
  );
}
    ...
    db
      ...
      .onConflictDoUpdate({
        ...
        set: {
          ...
          leftLowHouseNumber: sql`excluded.l_low_hn`,
          leftHighHouseNumber: sql`excluded.l_high_hn`,
          rightLowHouseNumber: sql`excluded.r_low_hn`,
          rightHighHouseNumber: sql`excluded.r_high_hn`,
