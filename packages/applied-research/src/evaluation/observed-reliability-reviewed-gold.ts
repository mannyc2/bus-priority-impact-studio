...
export type ObservedReliabilityReviewedFrontendUse =
  | "primary_finding"
  | "route_context"
  | "reviewer_only"
  | "needs_more_evidence"
...
export type ObservedReliabilityCalibrationTag =
  | "true_reliability_shortfall"
  | "route_month_rollup"
  | "gtfs_rt_sample_supported"
  | "schedule_baseline_supported"
  | "bwa_corroborated"
  | "direction_or_time_window_aggregation"
  | "low_gtfs_rt_samples"
...
export type ObservedReliabilityReviewedDecision = {
  readonly detectorId: string;
  readonly scopeId: string;
  readonly routeId: string | null;
  readonly sourceQueue: "candidate_review" | "skipped_control" | "clean_no_hit_control";
  readonly expectedFrontendUse: ObservedReliabilityReviewedFrontendUse;
  readonly calibrationTags: readonly ObservedReliabilityCalibrationTag[];
...
export type ObservedReliabilityGoldLabel = ObservedReliabilityReviewedDecision & {
...
export type ObservedReliabilityReviewedGoldArtifact = {
  readonly artifactKind: "observed_reliability_reviewed_gold";
  ...
  readonly labels: readonly ObservedReliabilityGoldLabel[];
};

export type ObservedReliabilityCandidateLike = {
...
export type ObservedReliabilityCoverageLike = {
  readonly detectorId?: unknown;
  readonly routeId?: unknown;
  readonly scopeId?: unknown;
...
export type ObservedReliabilityReviewedGoldEvaluation = {
  readonly artifactKind: "observed_reliability_reviewed_gold_evaluation";
  readonly schemaVersion: 1;
  readonly generatedAt: string;
  readonly releaseMonth: string;
  readonly asOfMonth: string;
  ...
  readonly byExpectedFrontendUse: Record<
    ObservedReliabilityReviewedFrontendUse,
  ...
  readonly byReviewDepth: Record<
    ...
    { readonly expected: number; readonly emitted: number; readonly dropped: number }
  >;
  readonly emittedReviewed: readonly ObservedReliabilityGoldLabel[];
  readonly droppedReviewed: readonly ObservedReliabilityGoldLabel[];
  readonly unreviewedEmittedCandidates: readonly ObservedReliabilityCandidateLike[];
};

export type ObservedReliabilityReadinessProjection = {
  readonly artifactKind: "observed_reliability_readiness_projection";
  readonly schemaVersion: 1;
  readonly generatedAt: string;
  readonly releaseMonth: string;
  readonly asOfMonth: string;
  ...
  readonly items: readonly {
    ...
    readonly reviewedFrontendUse: ObservedReliabilityReviewedFrontendUse | "unreviewed";
    readonly emittedCandidate: boolean;
    readonly reasonCode: string | null;
    readonly calibrationTags: readonly ObservedReliabilityCalibrationTag[];
    readonly label: ObservedReliabilityGoldLabel | null;
    readonly candidate: ObservedReliabilityCandidateLike | null;
  }[];
};

export type BuildObservedReliabilityReviewedGoldInput = {
  readonly generatedAt: string;
  readonly releaseMonth: string;
  readonly asOfMonth: string;
  readonly reviewQueuePath: string;
  readonly decisionsPath: string;
  readonly decisions: readonly ObservedReliabilityReviewedDecision[];
};

export type EvaluateObservedReliabilityReviewedGoldInput = {
  readonly generatedAt: string;
  readonly releaseMonth: string;
  readonly asOfMonth: string;
  readonly gold: ObservedReliabilityReviewedGoldArtifact;
  readonly candidates: readonly ObservedReliabilityCandidateLike[];
};

export type BuildObservedReliabilityReadinessProjectionInput =
  EvaluateObservedReliabilityReviewedGoldInput & {
    readonly coverage: readonly ObservedReliabilityCoverageLike[];
  };
...
export function buildObservedReliabilityReviewedGoldArtifact(
  input: BuildObservedReliabilityReviewedGoldInput,
): ObservedReliabilityReviewedGoldArtifact {
  const byCalibrationTag = new Map<ObservedReliabilityCalibrationTag, number>();
  const byReviewDepth = new Map<string, number>();
  const labels = input.decisions
    .map((decision): ObservedReliabilityGoldLabel => {
  ...
  return {
    artifactKind: "observed_reliability_reviewed_gold",
    schemaVersion: 1,
...
export function evaluateObservedReliabilityReviewedGold(
  input: EvaluateObservedReliabilityReviewedGoldInput,
): ObservedReliabilityReviewedGoldEvaluation {
  ...
  const byCalibrationTag = new Map<
    ObservedReliabilityCalibrationTag,
    { expected: number; emitted: number; dropped: number }
  >();
  ...
  return {
    artifactKind: "observed_reliability_reviewed_gold_evaluation",
    schemaVersion: 1,
    generatedAt: input.generatedAt,
    releaseMonth: input.releaseMonth,
    asOfMonth: input.asOfMonth,
...
export function buildObservedReliabilityReadinessProjection(
  input: BuildObservedReliabilityReadinessProjectionInput,
): ObservedReliabilityReadinessProjection {
  ...
  return {
    artifactKind: "observed_reliability_readiness_projection",
    schemaVersion: 1,
    generatedAt: input.generatedAt,
    releaseMonth: input.releaseMonth,
    asOfMonth: input.asOfMonth,
