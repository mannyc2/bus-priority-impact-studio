...
const MANIFEST: AnalysisDependencyDataProductManifest = {
  products: [
    { id: "intervention_panel_artifact", label: "Intervention panel", kind: "feature" },
    {
      id: "local_route_intervention_comparison_history",
      label: "Intervention comparison history",
      kind: "feature",
    },
    { id: "local_route_month_trends_history", label: "Route month trends", kind: "feature" },
    {
      id: "local_route_observed_reliability_summary_release",
      label: "Observed reliability release",
      kind: "feature",
    },
    {
      id: "tier2_structured_intervention_extraction_full_corpus",
      label: "Tier 2 structured intervention extraction",
      kind: "source",
    },
    {
      id: "applied_research_segment_daypart_panel",
      label: "Segment daypart panel",
      kind: "feature",
    },
    {
      id: "applied_research_pulse_candidate_set",
      label: "Pulse candidate set",
      kind: "feature",
    },
    {
      id: "applied_research_pulse_event_overlap",
      label: "Pulse event overlap",
      kind: "feature",
    },
    {
      id: "applied_research_event_effect_contrast",
      label: "Event effect contrast",
      kind: "feature",
    },
    {
      id: "applied_research_mechanism_corroboration",
      label: "Mechanism corroboration",
      kind: "feature",
    },
    {
      id: "applied_research_event_family_effect_panel",
      label: "Event family effect panel",
      kind: "feature",
    },
    {
      id: "applied_research_event_family_response_drift_study",
      label: "Event family response drift study",
      kind: "feature",
    },
    { id: "segment_daypart_history_artifact", label: "Segment daypart history", kind: "feature" },
  ],
};
...
describe("analysis dependency closure", () => {
  ...
  test("owns the detector closure artifact paths", () => {
    ...
    ).toBe("/artifacts/detector-closure/2023-04_to_2026-03/2026-03/detector-closure.json");
    expect(
      analysisDependencyClosureMarkdownPath({
        artifactRoot: "/artifacts",
        historyStartMonth: "2023-04",
    ...
    ).toBe("/artifacts/detector-closure/2023-04_to_2026-03/2026-03/detector-closure.md");
  });
});
