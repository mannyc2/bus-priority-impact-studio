...
| 080 | Accessible, searchable, shareable network decision explorer | P1 | L | 077, 079 | IN PROGRESS (079 merged at `11e21ee0`; shared rebind committed before parallel URL/model, runtime, and API lanes; integration owns Data Notes, mobile Sheet, borough behavior, and final QA) |
