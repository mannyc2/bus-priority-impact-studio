...
import type { ManifestSource, SocrataManifestSource } from "../src/source-manifest.js";
import { parseCurlHeadOutput, probeSource, writeProbeOutput } from "../src/source-probes.js";

const now = () => new Date("2026-04-27T00:00:00.000Z");

describe("source probes", () => {
  test("probes Socrata metadata and writes required metadata and columns files", async () => {
