  ...
  if (input.routeBatchStatus !== null) {
    statements.push(
      [
        ...
        "VALUES",
        `(${sqlString(input.routeBatchStatus.month)}, ${sqlString(input.routeBatchStatus.generatedAt)}, ${sqlString(input.routeBatchStatus.status)}, ${input.routeBatchStatus.routeCount}, ${input.routeBatchStatus.artifactCount}, ${input.routeBatchStatus.missingArtifactCount}, ${input.routeBatchStatus.hashMismatchCount}, ${input.routeBatchStatus.byteLengthMismatchCount}, ${input.routeBatchStatus.totalByteLength}, ${input.routeBatchStatus.issueCount});`,
      ].join(" "),
    );
  }
