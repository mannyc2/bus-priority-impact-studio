...
import { speedPaceShadowAuditPath } from "../../../src/commands/audit/speed-pace-shadow";

const commandPath = join(import.meta.dir, "../../../src/commands/audit/speed-pace-shadow.ts");

describe("speed pace route-month shadow audit boundary", () => {
  test("keeps shadow artifact construction and row loading out of the command", () => {
    ...
    expect(text).not.toContain("SPEED_PACE_HOTSPOT_DETECTOR_ID");
