...
const { BP_LIGHTHOUSE_URL, BP_RUN_LIGHTHOUSE, BP_WEB_AUDIT_DIR, CHROME_PATH } = process.env;
const auditDir = BP_WEB_AUDIT_DIR ?? "data/artifacts/web-audits/latest";
