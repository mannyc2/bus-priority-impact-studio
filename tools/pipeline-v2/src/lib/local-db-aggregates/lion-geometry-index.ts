...
import { ensureLionSegmentGeomColumn } from "./spatial-tables";

export type BuildLionGeometryIndexLocalDb = {
  readonly sqlite: Database;
};

export type BuildLionGeometryIndexInputs = {
  local: BuildLionGeometryIndexLocalDb;
...
export function unwrapGeoJsonGeometry(raw: string): string {
