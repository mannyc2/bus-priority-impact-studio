...
const sourceDisplayMeta: Record<string, SourceDisplayMeta> = {
  ...
  generated_route_slice_artifacts: {
    ...
    cadence: "Release",
    description:
      "Precomputed route artifacts that power route detail, segment rows, and public Studio projections.",
    schemaKeys: ["route_id", "month", "segment_id", "evidence_ref", "quality"],
    method: "studio-release",
    sourceRefCount: 12,
    use: "Generated serving projections, segment evidence, and public docs examples.",
    sourceLinks: [],
  },
};
